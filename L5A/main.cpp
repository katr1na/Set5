/* CSCI 200: Lab 5A: L5A - Recursion I: Towers of Hanoi
 *
 * Author: Katrina Ngo
 ...
 *
 * Complete the implementation so that the function is called recursively properly and solves the Towers of Hanoi task
 */
